...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFzaG1hcGJveCIsImEiOiJja2Y1OG1qNjYwMjdxMnhxZ2syY3czbmd2In0.uXZT7oWl6uHr9fhFOmi0Gg';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51HToYNLPmc91JdmbrFhU2SlU1Sv0A3GBpaokANqzWE0Cu4WOrfnXqROuTcZAMzV9GxxIXjiEbcXPl0RBxPpLSaux00Vday2TKV');
            _context.prev = 1;
            _context.next = 4;
